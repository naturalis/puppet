...
class rabbitmq(
  ...
  create_resources('rabbitmq_vhost',hiera('rabbitmq::vhost',[]))
  create_resources('rabbitmq_user',hiera('rabbitmq::user',[]))
  create_resources('rabbitmq_user_permissions',hiera('rabbitmq::user_permissions',[]))
