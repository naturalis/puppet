...
append url=http://raw.github.com/naturalis/puppet/master/private/scripts/preseed-ubuntu-puppetdev.seed initrd=/install/initrd.gz locale=en_US auto=true netcfg/get_hostname=puppetdev console-setup/ask_detect=false keyboard-configuration/layoutcode=us

label custom2
menu label ^Install Ubuntu 12.04, apply puppet manifest 'base'
kernel /install/vmlinuz
append url=http://raw.github.com/naturalis/puppet/master/private/scripts/preseed-ubuntu-base.seed initrd=/install/initrd.gz locale=en_US auto=true netcfg/get_hostname=base console-setup/ask_detect=false keyboard-configuration/layoutcode=us
EOF
